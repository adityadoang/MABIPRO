...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="font-headline-md text-headline-md font-bold text-primary dark:text-primary-fixed mb-2">Tambah Unit Baru</h1>
        <p class="font-body-md text-body-md text-on-surface-variant">Tambahkan data unit properti baru ke sistem.</p>
    </div>
