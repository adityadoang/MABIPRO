<div>
    ...
    <!-- Bento Grid Overview -->
    <section class="grid grid-cols-1 md:grid-cols-3 gap-gutter mt-6">
        ...
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <a href="{{ route('admin.users.index') }}" class="font-body-sm text-body-sm text-secondary hover:underline mt-2 inline-block" wire:navigate>Kelola Pengguna →</a>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-gutter mt-8">
        ...
        <section class="lg:col-span-2 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm flex flex-col">
            <div class="p-6 border-b border-outline-variant flex justify-between items-center bg-surface-container-low rounded-t-xl">
                ...
                <a href="{{ route('admin.users.index') }}" wire:navigate class="bg-secondary text-on-secondary font-label-md text-label-md py-2 px-4 rounded-lg flex items-center gap-2 hover:bg-on-secondary-container transition-colors shadow-sm">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="font-body-sm text-body-sm text-on-surface divide-y divide-outline-variant">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-4 px-6 text-center text-on-surface-variant">Belum ada pengguna</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
