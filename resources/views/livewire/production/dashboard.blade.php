            ...
            <div class="bg-surface-container-low rounded-xl border border-outline-variant p-6 shadow-sm">
                ...
                <div class="space-y-6">
                    @foreach($blocks as $block)
                        ...
                        <div class="bg-surface-container-high rounded-xl border-l-4 {{ $borderColor }} p-5 shadow-sm" wire:key="block-{{ $block->id }}">
                            ...
                            <div class="border-t border-outline-variant pt-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    @forelse($block->units as $unit)
                                        <a href="{{ route('production.show', $unit->id) }}" wire:navigate
        ...
        <div class="space-y-6">
            <div class="bg-surface-container-low rounded-xl border border-outline-variant p-5 shadow-sm sticky top-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button wire:click="$refresh" class="material-symbols-outlined text-on-surface-variant hover:text-primary transition-colors">refresh</button>
                </div>
                        ...
                        <div class="flex gap-3" wire:key="activity-{{ $activity->id }}">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="font-body-md text-sm text-on-surface">
                                    ...
                                    updated 
                                    <a href="{{ route('production.show', $activity->unit_id) }}" wire:navigate class="font-semibold text-primary hover:underline">
